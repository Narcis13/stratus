...
> **Stamped:** 2026-07-18 at commit `2104f46` (ST.7). (Sha-stamp trap: ST.6's real commit is `00b9615` not `b65266f`, ST.5's is `1f6b20f` not `bc3f1e8`, ST.4's is `15f2563` not `c1b0314`, ST.3's is `b82058b` not `292603d`, UI.10's is `c37d504` not `50948c9`, ST.2's is `dffd60a` not `860725f` — all amend-orphans, corrected here + in STATE.)
...
- Extension tests: bun:test on shared modules + studio (`templates.test.ts` (S5.6 code-card block; S5.7 thread-cover/list-card/parseListItems blocks), `codeTokens.test.ts` (S5.6 tokenizer splits + `MONO_ADVANCE`), `milestones.test.ts` (S5.5 crossing logic), `brandKit.test.ts`, `mascot.test.ts`, `compose.test.ts`); DOM fixtures via happy-dom (earlyReplies); `sidepanel/storage.test.ts` mocks `chrome.storage.local` for the settings round-trip + `resolveTheme` (UI.9).
