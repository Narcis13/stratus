...
> **Stamped:** 2026-07-18 at commit `47b10d2` (ST.9 — Studio docs+smoke+browser verification). (Sha-stamp trap: ST.8's real commit is `289ec2c` not `d38bbc5`, ST.7's is `acd95ec` not `2104f46`, ST.6's is `00b9615` not `b65266f`, ST.5's is `1f6b20f` not `bc3f1e8`, ST.4's is `15f2563` not `c1b0314`, ST.3's is `b82058b` not `292603d`, UI.10's is `c37d504` not `50948c9`, ST.2's is `dffd60a` not `860725f` — all amend-orphans, corrected here + in STATE.)
