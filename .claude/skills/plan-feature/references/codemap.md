...
> **Stamped:** 2026-07-18 at commit `c1b0314` (ST.4). (Sha-stamp trap: ST.3's real commit is `b82058b` not `292603d`, UI.10's is `c37d504` not `50948c9`, ST.2's is `dffd60a` not `860725f` — all amend-orphans, corrected here + in STATE.)
