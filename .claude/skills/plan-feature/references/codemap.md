...
> **Stamped:** 2026-07-18 at commit `ddecb5f` (RU.2 — reply `source` + radar draft `variants`/`model`/`reply_draft_id` columns, migration `0014`). (Sha-stamp trap: RU.1's real commit is `63df913` not `9c05464`; ST.9's is `d1902e5` not `47b10d2`, ST.8's `289ec2c` not `d38bbc5`, ST.7's `acd95ec` not `2104f46`, ST.6's `00b9615` not `b65266f`, ST.5's `1f6b20f` not `bc3f1e8`, ST.4's `15f2563` not `c1b0314`, ST.3's `b82058b` not `292603d`, UI.10's `c37d504` not `50948c9`, ST.2's `dffd60a` not `860725f` — all amend-orphans, corrected here + in STATE.)
...
| `radarDrafts` (L357) | C0 persisted batch replies; status `ready\|clicked\|expired` ratchet; 48h lazy expiry; `tags`; RU.2 adds `variants` JSON (3 angles, null until RU.3), `model`, `reply_draft_id` (soft link on confirm, no FK). |
