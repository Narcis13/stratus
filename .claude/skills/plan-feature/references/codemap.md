...
> **Stamped:** 2026-07-18 at commit `860725f` (ST.2).
...
- 2026-07-18 `860725f` — **ST.2**: behavior-neutral Studio shell refactor — new `src/sidepanel/studio/{registry,fields,KitEditor}.tsx` (template registry + `buildSpec` dispatch, dumb field/kit components); `Studio.tsx` 771→554 lines. §5 Tab-components + new `sidepanel/studio/` row.
