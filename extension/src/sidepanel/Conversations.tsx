...
// The mention-refresh budget went with the pull it rationed (2026-08-12):
// POST /x/mentions/refresh was the last billed X read this panel could trigger.
// The button below re-queries the local inbox and costs nothing, so nothing
// here needs metering anymore.
...
export function ConversationsSection({
  ...
  // Re-query the local inbox. $0 and unlimited — no X call happens anywhere
  // behind this; new mentions no longer arrive on their own at all.
    ...
    <Section
      ...
      actions={
        <button
          ...
          disabled={refreshing}
          title="Re-reads the stored inbox — $0, no X call"
        >
